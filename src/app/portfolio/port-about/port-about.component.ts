...
export class PortAboutComponent implements OnInit {
   ...
   ngOnInit(): void {
      this.aboutMe = [
         'I\'m currently a front-end web developer based in Ho Chi Minh City, VN. I have one year of experience with basic knowlegde in front-end web development. I\'m a quick learner, always willing to learn new skills in order to enhance my abilities. I learn myself all knowledge about front-end web development.',
